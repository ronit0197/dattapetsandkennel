<?php
    ...
    if(in_array($fileactualextension,$fileextentionsorted)){
        if($fileerror === 0){
            ...
            $destination = "../../images/slider/".$randomNumber.$filename;
            $uplodable_image = "images/slider/".$randomNumber.$filename;

            $sql = "INSERT INTO `slides`(`image`, `date&time`) VALUES ('$uplodable_image',current_timestamp())";
